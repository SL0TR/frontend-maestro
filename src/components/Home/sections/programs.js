  ...
  return (
    <section className="programs-container grid">
      ...
      <ScrollAnimation animateIn="slideInDownPrograms" animateOnce className="our-programs">
        <ScrollAnimation animateIn="fadeIn" animateOnce delay={700} className="our-programs--left">
          <h2>Our Programs</h2>
          <div className="thumb"></div>
        </ScrollAnimation>
        <ScrollAnimation  className="our-programs--right" animateIn="fadeIn" animateOnce delay={700}>
